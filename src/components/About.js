...
export default class About extends Component {
  render() {
    return (
      <div
        style={{ backgroundColor: "#FFCC66", height: "100%", padding: "25px" }}
      >
        <div
          style={{
            marginLeft: "auto",
          ...
          <CardGroup>
            <Card className="card about-card">
              ...
              <Card.Body>
                ...
                <Card.Text>Max.Philip@ibm.com</Card.Text>
              </Card.Body>
            </Card>
            <Card className="card about-card">
              {/* <Card.Img variant="top" src="holder.js/100px160" /> */}
              <Card.Body>
                ...
                <Card.Text>Christine.Liu1@ibm.com</Card.Text>
              </Card.Body>
            </Card>
            <Card className="card about-card">
              {/* <Card.Img variant="top" src="holder.js/100px160" /> */}
              <Card.Body>
                ...
                <Card.Text>Matthew.Cheah@ibm.com</Card.Text>
              </Card.Body>
            </Card>
            <Card className="card about-card">
              {/* <Card.Img variant="top" src="holder.js/100px160" /> */}
              <Card.Body>
                ...
                <Card.Text>Sarah.Karim@ibm.com</Card.Text>
              </Card.Body>
            </Card>
          </CardGroup>
        </div>
